...
$routing = array( // поддержка ЧПУ (SEF) для общедоступной части сайта
    ...
    'cap2sef' => array( // Controller/Action/Params => Search Engines Friendly
        ...
        'catalog/category/$1',
        // категория каталога, фильтр по функционалу
        ...
        // категория каталога, фильтр по функционалу, лидеры продаж
        '~^frontend/catalog/category/id/(\d+)/group/(\d+)/hit/1$~i' =>
        'catalog/category/$1/group/$2/hit/1',
        // категория каталога, фильтр по функционалу, новинки
        ...
        // категория каталога, фильтр по производителю, лидеры продаж
        '~^frontend/catalog/category/id/(\d+)/maker/(\d+)/hit/1$~i' =>
        'catalog/category/$1/maker/$2/hit/1',
        // категория каталога, фильтр по производителю, новинки
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж
        '~^frontend/catalog/category/id/(\d+)/group/(\d+)/maker/(\d+)/hit/1$~i' =>
        'catalog/category/$1/group/$2/maker/$3/hit/1',
        // категория каталога, фильтр по функционалу, фильтр по производителю, новинки
        ...
        // категория каталога, фильтр по производителю, лидеры продаж, новинки, сортировка
        '~^frontend/catalog/category/id/(\d+)/maker/(\d+)/hit/1/new/1/sort/(\d)$~i' =>
        'catalog/category/$1/maker/$2/hit/1/new/1/sort/$3',
        // категория каталога, фильтр по производителю, лидеры продаж, новинки, постраничная навигация
        '~^frontend/catalog/category/id/(\d+)/maker/(\d+)/hit/1/new/1/page/(\d+)$~i' =>
        'catalog/category/$1/maker/$2/hit/1/new/1/page/$3',
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, новинки, фильтр по параметрам
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, новинки, сортировка
        '~^frontend/catalog/category/id/(\d+)/group/(\d+)/maker/(\d+)/hit/1/new/1/sort/(\d)$~i' =>
        'catalog/category/$1/group/$2/maker/$3/hit/1/new/1/sort/$4',
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, новинки, постраничная навигация
        '~^frontend/catalog/category/id/(\d+)/group/(\d+)/maker/(\d+)/hit/1/new/1/page/(\d+)$~i' =>
        'catalog/category/$1/group/$2/maker/$3/hit/1/new/1/page/$4',
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, фильтр по параметрам, постраничная навигация
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, фильтр по параметрам, сортировка
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, новинки, фильтр по параметрам, постраничная навигация
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, новинки, сортировка, постраничная навигация
        ...
        // категория каталога, фильтр по производителю, лидеры продаж, новинки, сортировка, постраничная навигация
        '~^frontend/catalog/category/id/(\d+)/maker/(\d+)/hit/1/new/1/sort/(\d)/page/(\d+)$~i' =>
        'catalog/category/$1/maker/$2/hit/1/new/1/sort/$3/page/$4',
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, новинки, фильтр по параметрам, сортировка
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, новинки, фильтр по параметрам, постраничная навигация
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, новинки, сортировка, постраничная навигация
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, фильтр по параметрам, сортировка, постраничная навигация
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, новинки, фильтр по параметрам, сортировка, постраничная навигация
        ...
        // категория каталога, фильтр по функционалу, лидеры продаж, новинки, фильтр по параметрам, сортировка, постраничная навигация
    ...
    'sef2cap' => array( // Search Engines Friendly => Controller/Action/Params
        ...
        // категория каталога, фильтр по функционалу, фильтр по производителю, лидеры продаж, сортировка
        '~^catalog/category/$1/group/$2/maker/$3/hit/1/sort/(\d)$~i' =>

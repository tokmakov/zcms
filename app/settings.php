...
$settings = array(
	...
	'meta' => array(
		'default' => array( // значения по умолчанию для title, мета-тегов keywords и description
			'title' => 'Торговый Дом ТИНКО',
			'keywords' => 'охранно-пожарная сигнализация, ОПС, видеонаблюдение, охранное телевидение, СКУД, оповещение, кабель, провод, пожаротушение',
		...
		'news' => array( // значения по умолчанию для ленты новостей
			...
			'description' => 'Новости, события, выставки. Торговый Дом ТИНКО.',
		),
		'page' => array( // значения по умолчанию для страниц
			...
			'description' => 'Торговый Дом ТИНКО. Технические средства безопасности.  Комплексные поставки оборудования.',
		),
	),

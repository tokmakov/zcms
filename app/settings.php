...
$settings = array(
	...
	'meta' => array(
		'default' => array( // значения по умолчанию для title, мета-тегов keywords и description
			'title' => 'Группа компаний ИТЦ и КИС',
			'keywords' => 'инженерные системы, проектирование, монтаж, обслуживание, ОПС, видеонаблюдение, СКУД, оповещение, кабель, провод, пожаротушение',
			'description' => 'Группа компаний КИС и ИТЦ. Проектирование, монтаж и обслуживание инженерных систем. Комплексные поставки оборудования.',
		),
		'catalog' => array( // значения по умолчанию для каталога
			'title' => 'Каталог оборудования. Группа компаний ИТЦ и КИС',
			'keywords' => 'каталог, оборудование, купить, ОПС, СКУД, домофон, оповещение, кабель, провод, пожаротушение',
		...
		'news' => array( // значения по умолчанию для ленты новостей
			'title' => 'Новости, события, выставки. Группа компаний КИС и ИТЦ.',
			'keywords' => 'новости, события, проектирование, монтаж, обслуживание, ОПС, СКУД, домофон, оповещение, кабель, провод, пожаротушение',
			'description' => 'Новости, события, выставки. Группа компаний КИС и ИТЦ.',
		),
		'page' => array( // значения по умолчанию для страниц
			'title' => 'Группа компаний КИС и ИТЦ',
			'keywords' => 'инженерные системы, проектирование, монтаж, обслуживание, ОПС, видеонаблюдение, СКУД, оповещение, кабель, провод, пожаротушение',
			'description' => 'Группа компаний КИС и ИТЦ. Проектирование, монтаж и обслуживание инженерных систем.  Комплексные поставки оборудования.',
		),
	),
	...
	'cache' => array(
		'enable' => false, // включить кэширование данных
	...
	'js' => array( // js-файлы, подключаемые к странице
		'frontend' => array( // общедоступная часть сайта
			 ...
			 * 'page' => 'page.js',            // только для страниц, формируемых Page_Frontend_Controller

<?php
/**
 * Абстрактный класс Solutions_Backend_Controller, родительский для всех
 * контроллеров, работающих с типовыми решениями, административная часть
 * сайта
 */
abstract class Solutions_Backend_Controller extends Backend_Controller {
     ...
     * потомков класса Solutions_Backend_Controller
     */
    protected function input() {
         ...
         * потомков Solutions_Backend_Controller
         */
        parent::input();

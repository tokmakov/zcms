<?php
/**
 * Класс Xhr_Getprd_Solutions_Backend_Controller формирует ответ на запрос XmlHttpRequest
 ...
 */
class Xhr_Getprd_Solutions_Backend_Controller extends Solutions_Backend_Controller {

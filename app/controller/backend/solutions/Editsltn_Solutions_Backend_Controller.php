<?php
/**
 * Класс Editsltn_Solutions_Backend_Controller формирует страницу с формой для
 * редактирования типового решения. Получает данные от модели Solutions_Backend_Model,
 * административная часть сайта
 */
class Editsltn_Solutions_Backend_Controller extends Solutions_Backend_Controller {
    ...
    protected function input() {
         ...
         * Editsltn_Solutions_Backend_Controller
         */
        parent::input();
        ...
        if ($this->isPostMethod()) {
            if ($this->validateForm()) { // ошибок не было, обновление типового решения прошло успешно
                ...
                $this->redirect($this->solutionsBackendModel->getURL('backend/solutions/editsltn/id/' . $this->params['id']));
            }
        }
        ...
        $solution = $this->solutionsBackendModel->getSolution($this->params['id']);
        ...
        $this->centerVars = array(
            ...
            'action'      => $this->solutionsBackendModel->getURL('backend/solutions/editsltn/id/' . $this->params['id']),
        ...
        if ($this->issetSessionData('editSolutionsItemForm')) {
            $this->centerVars['savedFormData'] = $this->getSessionData('editSolutionsItemForm');
            $this->centerVars['errorMessage'] = $this->centerVars['savedFormData']['errorMessage'];
            unset($this->centerVars['savedFormData']['errorMessage']);
            $this->unsetSessionData('editSolutionsItemForm');
        }
    ...
    protected function validateForm() {
        ...
        if ( ! empty($errorMessage)) {
            ...
            $this->setSessionData('editSolutionsItemForm', $data);
            return false;
        }
        ...
        $this->solutionsBackendModel->updateSolution($data);

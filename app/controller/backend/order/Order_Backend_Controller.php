 ...
 * работающих с заказами пользователя, административная часть сайта
 */
abstract class Order_Backend_Controller extends Backend_Controller {
     ...
     * потомков класса Order_Backend_Controller
     */

<?php
/**
 * Класс Ajaxparams_Filter_Backend_Controller формирует ответ на запрос XmlHttpRequest
 ...
 */
class Ajaxparams_Filter_Backend_Controller extends Filter_Backend_Controller {
    ...
    public function request() {
        ...
        $this->output = $this->render(
            $this->config->site->theme . '/backend/template/filter/ajax/params.php',
            array(
                'allParams' => $allParams,
                'params' => $params,
            )

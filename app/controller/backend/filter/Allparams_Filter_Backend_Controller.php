...
class Allparams_Filter_Backend_Controller extends Filter_Backend_Controller {
     ...
     * со списком всех параметров подбора
     */
    protected function input() {
         ...
         * Allparams_Filter_Backend_Controller
         */
        parent::input();

        $this->title = 'Параметры. ' . $this->title;
        ...
        $params = $this->filterBackendModel->getAllParams();
        ...
        $this->centerVars = array(
            ...
            // URL страницы с формой для добавления нового параметра
            'addParamUrl'   => $this->filterBackendModel->getURL('backend/filter/addparam'),

<?php
/**
 * Класс Rmvctg_Article_Backend_Controller отвечает за удаление категории статей,
 * взаимодействует с моделью Article_Backend_Model, административная часть сайта
 */
class Rmvctg_Article_Backend_Controller extends Article_Backend_Controller {
    ...
    protected function input() {
        ...
        if (isset($this->params['id']) && ctype_digit($this->params['id'])) {
            ...
            $this->articleBackendModel->removeCategory($this->params['id']);
        }

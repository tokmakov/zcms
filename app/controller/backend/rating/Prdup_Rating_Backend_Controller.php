<?php
/**
 * Класс Prdup_Rating_Backend_Controller поднимает товар вверх в списке,
 * взаимодействует с моделью Rating_Backend_Model, административная часть
 * сайта
 */
class Prdup_Rating_Backend_Controller extends Rating_Backend_Controller {
    ...
    protected function input() {
        ...
        // после успешного выполнения операции смещения товара вверх и редиректа
        $return = 0;
        // если передан id товара и id товара целое положительное число
        if (isset($this->params['id']) && ctype_digit($this->params['id'])) {
            $this->params['id'] = (int)$this->params['id'];
            $this->ratingBackendModel->moveProductUp($this->params['id']);

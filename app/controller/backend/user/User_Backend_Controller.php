 ...
 * работающих с пользователями сайта, административная часть сайта
 */
abstract class User_Backend_Controller extends Backend_Controller {
     ...
     * потомков класса User_Backend_Controller
     */

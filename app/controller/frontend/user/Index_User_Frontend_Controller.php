<?php
/**
 * Класс Index_User_Frontend_Controller формирует страницу личного кабинета пользователя
 * (если он авторизован) или перенаправляет на страницу авторизации, получает данные от

<?php
/**
 * Класс Addprd_Compare_Frontend_Controller отвечает за добавление товара
 * к сравнению, взаимодействует с моделью Compare_Frontend_Model,
 * общедоступная часть сайта
 */
class Addprd_Compare_Frontend_Controller extends Compare_Frontend_Controller {
    ...
    /**
     * Функция добавляет товар к сравнению и делает редирект на страницу
     * со списком товаров для сравнения или обратно на страницу, где была

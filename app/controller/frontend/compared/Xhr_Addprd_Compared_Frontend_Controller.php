<?php
/**
 * Класс Xhr_Addprd_Compared_Frontend_Controller принимает запрос XmlHttpRequest,
 * добавляет товар в список сравнения, работает с моделью Compared_Frontend_Model,
 * общедоступная часть сайта
 */
class Xhr_Addprd_Compared_Frontend_Controller extends Compared_Frontend_Controller {

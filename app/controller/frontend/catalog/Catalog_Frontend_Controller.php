<?php
/**
 * Абстрактный класс Catalog_Frontend_Controller, родительский для всех контроллеров,
 * работающих с каталогом товаров, общедоступная часть сайта
 */
abstract class Catalog_Frontend_Controller extends Frontend_Controller {

$(document).ready(function() {
    ...
    var lastFilesRow = $('#add-edit-news-item #new-files > div:last-child > div:last-child');
    ...
    $('#add-edit-news-item #new-files > div:last-child > div > span:first-of-type').click(function() {
        lastFilesRow.clone(true).insertAfter($(this).parent()).show();
    });
    // кнопка для удаления строки загрузки файла
    $('#add-edit-news-item #new-files > div:last-child > div > span:last-of-type').click(function() {
        $(this).parent().remove();
    ...
    $('#add-edit-news-item #old-files > div:last-child > div > span').click(function() {

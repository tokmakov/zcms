<?php
/**
 * Старница с формой для редактирования параметра подбора,
 * файл view/example/backend/template/filter/editparam/center.php,
...
<!-- Начало шаблона view/example/backend/template/filter/editparam/center.php -->
...
<!-- Конец шаблона шаблона view/example/backend/template/filter/editparam/center.php -->

 ...
 * файл view/example/backend/template/admin/filter/allparams/center.php,
...
<!-- Начало шаблона view/example/backend/template/admin/filter/allparams/center.php -->
...
<!-- Конец шаблона шаблона view/example/backend/template/admin/filter/allparams/center.php -->

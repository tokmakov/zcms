<?php
/**
 * Форма для добавления вакансии компании,
 * файл view/example/backend/template/vacancy/add/center.php,
...
<!-- Начало шаблона view/example/backend/template/vacancy/add/center.php -->
...
<form action="<?php echo $action; ?>" method="post" id="add-edit-vacancy">
    <div>
...
<!-- Конец шаблона view/example/backend/template/vacancy/add/center.php -->

 ...
 * файл view/example/backend/template/news/editnews/center.php,
 ...
 * $excerpt - анонс новости
 * $body - текст новости в формате html
 * $date - текущая дата
 * $time - текущее время
 * $files - массив имен файлов
...
<!-- Начало шаблона view/example/backend/template/news/editnews/center.php -->
...
<div id="add-edit-news-item">
    ...
    <div>
        ...
        <div>
            ...
            <?php if (is_file('./files/news/' . $id . '/' . $id . '.jpg')): ?>
                <input type="checkbox" name="remove_image" value="1" /> удалить
                <a href="/files/news/<?php echo $id; ?>/<?php echo $id; ?>.jpg" class="zoom">изображение</a>
            <?php endif; ?>
        </div>
    </div>
    <div>
        ...
        <div id="old-files">
            ...
            <div>
                <?php foreach ($files as $file): ?>
                    <div>
                        <a href="/files/news/<?php echo $id . '/' . $file; ?>" target="_blank"><?php echo $file; ?></a>
                        <span>вставить</span>
...
<!-- Конец шаблона view/example/backend/template/news/editnews/center.php -->

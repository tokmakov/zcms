 ...
 * файл view/example/backend/template/blog/category/center.php,
...
<!-- Начало шаблона view/example/backend/template/blog/category/center.php -->
...
<?php if (!empty($posts)): // список постов выбранной категории ?>
    <ul>
...
<!-- Конец шаблона view/example/backend/template/blog/category/center.php -->

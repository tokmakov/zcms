	...
	$('#category-filters form select[name="group"]').change(function() {
		...
		$('#category-filters form').ajaxSubmit({
			...
			beforeSubmit: function() {
				...
				$('#category-childs > div:last-child').height(childsHeight).html('').addClass('ajax-filter-loader');
				$('#category-filters form > div:nth-child(3)').html('').addClass('ajax-fields-loader');
				$('#category-products').html('').addClass('ajax-filter-loader');
			},
			success: function(data) {
				$('#category-childs > div:last-child').removeClass('ajax-filter-loader').html(data.childs);
				...
				$('#category-filters form > div:nth-child(3) select').change(function() {
					...
					$('#category-filters form').ajaxSubmit({
						...
						success: function(dt) {
							$('#category-childs > div:last-child').removeClass('ajax-filter-loader').html(dt.childs);
